...
import { logInValidation } from "@/utils/validated/formvalidate";
import { useRouter } from "next/navigation";
import { logInUser } from "@/utils/allFunctions/allFunctions";
const login = () => {
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        setErrors({});
        const validated = logInValidation.safeParse(formJson);
        ...
        try {
            const response = await logInUser(formJson);
